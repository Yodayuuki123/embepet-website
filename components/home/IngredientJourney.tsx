...
const steps = [
  {
    ...
    body: "Ingredient identity, supplier records and applicable specifications are reviewed against the approved project before production use.",
    stat: "By lot",
    statLabel: "material records",
    color: "#7FB08F",
  },
  {
    icon: FlaskConical,
    ...
    body: "The target market, intended claim, serving format and approved specification guide formulation and sample review.",
    stat: "6",
  ...
  },
  {
    ...
    body: "Production is performed in the GMP-audited and SQF-certified facility against the approved formula, process and packaging records.",
    stat: "3",
    statLabel: "production lines",
    color: "#DE8F63",
  },
  {
    icon: BadgeCheck,
    kicker: "04 · Verification",
    title: "Released to specification",
    body: "Applicable physical, microbiological or assay checks are defined by project and reviewed with the related batch records before release.",
    stat: "By spec",
    statLabel: "release criteria",
    color: "#A5BC85",
  },
];
